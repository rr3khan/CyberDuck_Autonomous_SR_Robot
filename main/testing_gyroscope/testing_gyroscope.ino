...
//  Serial.println();
  ...
  // Print yaw using gyro

  // Print yaw using  magnetometer and accelerometer

   Serial.print(getYawMag());
   Serial.println("Degrees using Mag and Accel");

   Serial.print(getYawGyro());
   Serial.println("Degrees integrating Gyro");
...
// calculate yaw using magnetometer and accelerometer
float getYawMag(){ 
    // Source:
